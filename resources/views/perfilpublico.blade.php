...
-->
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body"><a href="../index.html">freelaunch.com</a></div>
          </div>
                ...
                <hr>
                  <form class="form" action="##" method="post" id="registrationForm">
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Nombre</h4></label><br>
                              <label for="nombre"><h4>{{$user->name}}</label>                          
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Email</h4></label><br>
                              <label for="nombre"><h4>{{$user->email}}</label>                          
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Edad</h4></label><br>
                              <label for="nombre"><h4>{{$user->age}}</label>                          
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Descripción</h4></label><br>
                              <label for="nombre"><h4>{{$user->description}}</label>                          
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Ocupación</h4></label><br>
                              <label for="nombre"><h4>{{$user->ocupation}}</label>                          
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Habilidades</h4></label><br>
                              <label for="nombre"><h4>{{$user->habilities}}</label>                          
                          </div>
                      </div>
